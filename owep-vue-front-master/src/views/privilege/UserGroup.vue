<template>
	<div>
		...
		<!-- 分配角色弹出框 -->
		<el-dialog title="分配角色" v-model="groupVisible" width="30%">
			<el-form label-width="85px">
				<el-form-item label="组名" >
					<el-input v-model="formGroup.groupName" disabled></el-input>
				</el-form-item>
...
import { getUserGroup} from '../../api/privlege';
//是否启用
...
const getData = () => {
    ...
    getUserGroup({pageCurrent:query.pageIndex,pageSize:query.pageSize}).then(res=>{
        console.log(res,"---res---")
...
const saveEdit = () => {
	...
	tableData.value[idx].index = form.index;
...
const allocationRole =(index,row)=>{
  console.log(index);
  formGroup.groupName = row.groupName
